...
LTI blocks compatible for deep learning in our previous \structure{dynoNet} architecture
\vskip 1em
\begin{columns}
 \column{.5\textwidth}
 \centering
...
\begin{itemize}
 	...
 	\structure{M. Forgione and D.Piga.}
 		...
 		\end{tiny}
\end{itemize}
Differentiable transfer functions now available in the \href{https://pytorch.org/audio/main/generated/torchaudio.functional.lfilter.html}{\texttt{torchaudio}} library.
\begin{itemize}
