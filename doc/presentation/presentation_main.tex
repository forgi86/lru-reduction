...
Our paper included in the documentation of {\texttt{torchaudio.lfilter}}.
\begin{itemize}
...
\end{figure}
Focus on making the LTI system simulation/learning \structure{fast and well-posed}.
\begin{itemize}
 	\item[\book]
 		\begin{tiny}
...
\item Singular perturbation $\Rightarrow$ solve for $x_{2}(k) = x_{2}(k-1)$
%\begin{small}
%\begin{align*}
